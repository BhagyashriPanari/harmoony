...
<body>
	...
	<section class="hero-wrap hero-wrap-2" style="background-image: url('images/vie6.jpg');" data-stellar-background-ratio="0.5">
	...
	<section class="ftco-section" id="about-section">
		<div class="container">
		<!--<center><h1 class="mb-4 gallery-title"><font size="+4" color="#fc5e28" face="Times New Roman, Times, serif"><b>About Us</h1></font></b>-->
			<div class="row">
				<div class="col-md-6 d-flex align-items-stretch">
					<div class="about-wrap img w-100" style="background-image: url(images/J.jpg);">
						<div class="icon d-flex align-items-center justify-content-center"><!--<span class="flaticon-crane"></span>--><img src="images/output-onlinetools (3).png"></div>
					</div>
				</div>
				<div class="col-md-6 py-5 pl-md-5">
					<div class="row justify-content-center mb-4 pt-md-4">
						<div class="col-md-12 heading-section ftco-animate">
							<span class="subheading"><font face="Times New Roman, Times, serif" color="#006600" size="+2">Welcome to HDS</font></span>
							<marquee behavior="slide" direction="left" scrollamount="18"><h1 class="mb-4"><b><font face="Times New Roman, Times, serif" color="#fc5e28" size="+2">HDS a Designing Company</font></b></h1></marquee>
							<div class="d-flex about">
								<div class="icon"><!--<span class="flaticon-hammer"></span>--><img src="images/OIP.jpeg"></div>
								<h3><font color="#006600">We're in this business since 2017 and We provide the best insdustrial services</font></h3>
							</div>
							<p><font size="+1">Fusion of ideas of Snehal Chavan and Pratiksha Deshpande came together to render services to client to see the picturesque of their projects. We search and research solutions for our client's design problems and aspirations.</font></p>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-12 text-center">
					<div class="img"  style="background-image: url(images/view19.jpg);">
						<div class="overlay"></div>
						<h2><font face="Times New Roman, Times, serif">Stylofy your space and Heritage!</font></h2>
						<p>We can manage the design that drives you forward.</p>
		...
		<div class="container">
			<div class="row justify-content-center mb-5 pb-3">
				<div class="col-md-7 text-center heading-section ftco-animate">
					...
					<h2 class="mb-4 what-we-do">
  <font face="Times New Roman, Times, serif">What we do?</font>
</h2>
						...
						<div class="flipper">
							<div class="front">
								<div class="box">
									...
									<p style="padding-top:10px"><h2>Interior Design</h2></p>
							...
							<div class="back">
								<!-- back content -->
								<blockquote>
									<p>I) INTERIOR DESIGN -</p>
<br><br>&nbsp;&nbsp;A . 2D - Layouts
<br>&nbsp;&nbsp;B . 3D - Layouts 
<br>&nbsp;&nbsp;<font color="#FFFFFF">INTERIOR SERVICES :</font>
...
<br>&nbsp;&nbsp;&nbsp;*Consultation and Supervision
								...
								<div class="author d-flex">
									...
									<div class="name align-self-center ml-3"><!--Anderson <span class="position">Head Engineer</span>--></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-6 col-sm-6">
					<div class="block-2 ftco-animate">
						<div class="flipper">
							<div class="front">
								<div class="box">
								<img src="images/arch5.jpg">
									<p style="padding-top:10px"><h2>Architectural Design</h2></p>
									<!--<p>Head Engineer</p>-->
								</div>
							</div>
							<div class="back">
								<!-- back content -->
								<blockquote>
									<p>II) ARCHITECTURAL DESIGN -</p>
<br><br>&nbsp;&nbsp;A . 2D - Layouts
<br>&nbsp;&nbsp;B . Exterior 3D Work 
<br><font color="#FFFFFF">&nbsp;&nbsp;Architectural Services :</font>
<br>&nbsp;&nbsp;&nbsp;*Consultation and Supervision.
								</blockquote>
								<div class="author d-flex">
									<div class="image align-self-center">
    ...
    <font color="#000000">Code Crafter Services</font><!--Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>-->
