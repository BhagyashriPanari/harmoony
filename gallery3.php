...
<section class="ftco-section bg-light">
  <div class="container">
 <center><h1 class="mb-4 gallery-title"><font size="+4"><b>Interior Design</b></font></h1>
    <div class="row d-flex" style="background-color:#FFCC66">
      <div class="col-lg-4 ftco-animate">
        <div class="gallery-entry">
          <a class="block-20" style="background-image: url('images/b1.jpg');">
          </a>
   ...
   <div class="col-lg-4 ftco-animate">
    <div class="gallery-entry">
      <a class="block-20" style="background-image: url('images/view101.jpg');">
      </a>
      <div class="text d-block">
       <div class="meta">
        <p>
...
<div class="col-lg-4 ftco-animate">
  <div class="gallery-entry">
    <a class="block-20" style="background-image: url(images/b3.jpeg);">
    </a>
    <div class="text d-block">
     <div class="meta">
      <p>
