...
<head>
  ...
  font-size: xx-large; /* Or adjust based on your needs */
}
	</style>
</head>
<body>
...
<!-- END nav -->
<section class="hero-wrap hero-wrap-2" style="background-image: url('images/vie7.jpg');" data-stellar-background-ratio="0.5">
  <div class="overlay"></div>
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-start">
      <div class="col-md-9 ftco-animate pb-5">
       <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a></span> <span>Our Gallery <i class="fa fa-chevron-right"></i></span></p>
...
<section class="ftco-section bg-light">
  <div class="container">
 <center><h1 class="mb-4 gallery-title"><font size="+4"><b>Exterior Design</b></font></h1>
    <div class="row d-flex" style="background-color:#FFCC66">
      <div class="col-lg-4 ftco-animate">
        <div class="gallery-entry">
          <a class="block-20" style="background-image:url(images/al1.jpg)">
          </a>
          <div class="text d-block">
           <div class="meta">
            <p>
            <!--<a href="#">--><font color="#040e26"><span class="fa fa-calendar mr-2"></span>Sept. 06, 2020</font><!--</a>-->
									<!--<a href="#">--><!--<span class="fa fa-user mr-2"></span>Admin--><!--</a>-->
									<!--<a href="#" class="meta-chat">--><!--<span class="fa fa-comment mr-2"></span> 3--><!--</a>-->
								</p>
							</div>
							<center><button style="background-color:#040e26; color: #FFFFFF; font-family: 'Times New Roman', Times, serif; text-decoration: none; padding: 10px 20px; border-radius: 5px; border: none; cursor: pointer;">
    Residential Exterior Design
</button></center><!--<h3 class="heading" style="background-color:#040e26" align="center"><a href="">Hall Design</a></h3>--><!--<h3 class="heading" style="background-color:#040e26; text-align:center;">
    <a href="#" style="color: #FFFFFF; font-family: 'Times New Roman', Times, serif; text-decoration: none; display: inline-block; padding: 10px 20px; border-radius: 5px;">
        Hall Design
    </a>
</h3>-->

							<!--<p><a href="gallery.php" class="btn btn-secondary py-2 px-3">Read more</a></p>-->
       </div>
     </div>
   </div>
   ...
   <div class="col-lg-4 ftco-animate">
    <div class="gallery-entry">
      <a class="block-20" style="background-image:url(images/arch2.jpg)">
      </a>
      <div class="text d-block">
       <div class="meta">
        <p>
         <!--<a href="#">--><font color="#040e26"><span class="fa fa-calendar mr-2"></span>Sept. 06, 2020</font><!--</a>-->
							...
							<center><button style="background-color:#040e26; color: #FFFFFF; font-family: 'Times New Roman', Times, serif; text-decoration: none; padding: 10px 20px; border-radius: 5px; border: none; cursor: pointer;">
    Buddha Vihar Exterior Design
</button></center><!--<h3 class="heading" style="background-color:#040e26; text-align:center;">
    <a href="#" style="color: #FFFFFF; font-family: 'Times New Roman', Times, serif; text-decoration: none; display: inline-block; padding: 10px 20px; border-radius: 5px;">
       Cabin Design
    </a>
</h3>-->
...
<div class="col-lg-4 ftco-animate">
  <div class="gallery-entry">
    <a class="block-20" style="background-image:url(images/ser.jpg)">
    </a>
    <div class="text d-block">
     <div class="meta">
      <p>
...
<footer class="ftco-footer">
    ...
    <font color="#000000">Code Crafter Services</font>
</a><!--Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>-->
