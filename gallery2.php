...
<section class="ftco-section bg-light">
  <div class="container">
 <center><h1 class="mb-4 gallery-title"><font size="+4"><b>Commercial Design</b></font></h1>
    <div class="row d-flex" style="background-color:#FFCC66">
      <div class="col-lg-4 ftco-animate">
        <div class="gallery-entry">
          <a class="block-20" style="background-image:url(images/IMG_7361.JPG);">
          </a>
   ...
   <div class="col-lg-4 ftco-animate">
    <div class="gallery-entry">
      <a class="block-20" style="background-image: url(images/b2.jpg);">
      </a>
      <div class="text d-block">
       <div class="meta">
        <p>
...
<div class="col-lg-4 ftco-animate">
  <div class="gallery-entry">
    <a class="block-20" style="background-image:url(images/g.jpeg)">
    </a>
    <div class="text d-block">
     <div class="meta">
      <p>
